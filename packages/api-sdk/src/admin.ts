...
type AdminCompanyMutableFields = {
  logo_url?: string | null;
  description?: string | null;
  short_description?: string | null;
  category?: string | null;
...
export type AdminCompanyCreatePayload = AdminCompanyMutableFields & {
  name: string;
  url: string;
};

export type AdminCompanyUpdatePayload = AdminCompanyMutableFields & {
  name?: string;
  url?: string;
};
