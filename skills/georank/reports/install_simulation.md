...
- OK: `True`
- Package directory: `[workspace]/tmp/georank-skill-review-20260716/package`
...
| Check | Status | Detail |
| --- | --- | --- |
| `archive-present` | `pass` | Package archive exists: [workspace]/tmp/georank-skill-review-20260716/package/georank.zip |
| `archive-safe-paths` | `pass` | Archive has no absolute or parent-traversal entries |
| `single-top-level` | `pass` | Archive top-level directory is georank |
...
| `permission-claude-interactive-approved` | `pass` | claude capability interactive has active reviewer approval |
| `permission-claude-interactive-target-enforcement` | `pass` | claude capability interactive has target enforcement note |
...
| `permission-generic-interactive-approved` | `pass` | generic capability interactive has active reviewer approval |
| `permission-generic-interactive-target-enforcement` | `pass` | generic capability interactive has target enforcement note |
...
| `permission-openai-interactive-approved` | `pass` | openai capability interactive has active reviewer approval |
| `permission-openai-interactive-target-enforcement` | `pass` | openai capability interactive has target enforcement note |
...
| `permission-vscode-interactive-approved` | `pass` | vscode capability interactive has active reviewer approval |
| `permission-vscode-interactive-target-enforcement` | `pass` | vscode capability interactive has target enforcement note |
