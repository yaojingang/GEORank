...
- Archive SHA256: `45f2038c923615ee4cdddb02604df674f4540a4a0fd39ddb55d6f0ac2a700645`
- Failures: `0`
- Warnings: `0`
...
| Check | Status | Detail |
| --- | --- | --- |
| `package-manifest` | `pass` | Package manifest exists: [workspace]/tmp/georank-skill-review-20260716/package/manifest.json |
...
| `archive-entry-georank/SKILL.md` | `pass` | Archive contains georank/SKILL.md |
| `archive-entry-georank/manifest.json` | `pass` | Archive contains georank/manifest.json |
| `archive-entry-georank/agents/interface.yaml` | `pass` | Archive contains georank/agents/interface.yaml |
