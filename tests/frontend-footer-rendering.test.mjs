...
test('custom homepage source and published mirrors use the same copyright', async () => {
  const files = [
    'runtime/homepages/public/releases/9fe4a087-42bc-423a-bc59-fc020018a6f9/index.html',
    'runtime/homepages/releases/9fe4a087-42bc-423a-bc59-fc020018a6f9/source/index.html'
  ];
