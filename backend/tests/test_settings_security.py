...
class SettingsSecurityTests(unittest.TestCase):
    ...
    def test_sensitive_category_matching_is_case_insensitive(self):
        self.assertTrue(is_sensitive_setting("custom_credential", "API_KEYS"))

    def test_sensitive_key_and_category_ignore_surrounding_whitespace(self):
        self.assertTrue(is_sensitive_setting("  llm_api_key\t", " basic "))
        self.assertTrue(is_sensitive_setting("custom_credential", "\nAPI_KEYS  "))
